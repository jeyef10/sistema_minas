                            ...
                            <tbody>
                                @foreach ($recaudos as $recaudo)
                                    <tr>
                                        ...
                                        <td>
                                            @can('editar-recaudo')
                                                <a class="btn btn-warning btn-sm" style="margin-left: 40%;" href="{{ route('recaudo.edit',$recaudo->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
