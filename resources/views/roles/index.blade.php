                ...
                <div class="col-lg-12">
                    <div class="card mb-4">
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <h2 class="font-weight-bold text-primary" style="margin-left: 38%;">Gestión de Roles</h2>
                            ...
                            <table class="table align-items-center table-flush" id="dataTable">
                                <thead class="thead-light">
                                    <tr class="text-white">
                                        ...
                                        <th class="col-2" class="font-weight-bold text-Secondary"><center>Acciones</center> </th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    @foreach ($roles as $role)
                                        <tr>
                                            <!-- <td class="font-weight-bold text-Secondary">{{ $role->id}}</td> -->
                                            <td class="font-weight-bold text-Secondary">{{ $role->name }}</td>
            
                                            <td>
                                                @can('editar-rol')
                                                    <a class="btn btn-warning btn-sm" style="margin-left: 35%;" href="{{ route('roles.edit',$role->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
