                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <td class="font-weight-bold text-Secondary">{{ $recepcion->id}}</td> --}}
                                        ...
                                        <td>
                                            <a class="btn btn-secondary btn-sm" title="Planificar" href="{{ route('planificacion.create', $recepcion->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-incognito" viewBox="0 0 16 16">
