                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="apellido" name="apellidos"  oninput="capitalizarInput('apellido')" style="background: white;" value="" placeholder="Ingrese El Apellido" autocomplete="off" onkeypress="return soloLetras(event);">
                                </div>
                                
                                <div class="col-4">
                                    <label  class="font-weight-bold text-primary">Municipio</label>
                                    <select class="select2-single form-control" id="c_municipio" name="municipio">
