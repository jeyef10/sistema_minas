...
<title>@yield('title') Registrar Entidad Bancaria</title>
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4"></div>
            <div class="col-lg-12">
                <div class="card mb-4">
                    ...
                    <h2 class="font-weight-bold text-primary" style="margin-left: 44%;">Registrar Entidad Bancaria</h2>
    
                    </div>
                
                    <form method="post" action="{{ route('banco.store') }}" enctype="multipart/form-data" onsubmit="return Banco(this)">
                        @csrf
