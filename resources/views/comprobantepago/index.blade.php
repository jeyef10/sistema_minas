                        ...
                        <table class="table align-items-center table-flush" id="dataTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th class="font-weight-bold text-Secondary">Estatus Respuesta</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div style="display: flex; justify-content: center;">
                                                ...
                                                <a class="btn btn-warning btn-sm" style="margin: 0 1px;" title="Desea Editar la Inspección" href="{{ route('inspeccion.edit', $inspeccion->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
