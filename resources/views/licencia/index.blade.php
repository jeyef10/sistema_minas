                            ...
                            <tbody>
                                ...
                                @foreach ($inspecciones as $inspeccion)
                                    <tr>
                                        ...
                                        <td>
                                             <a class="btn btn-secondary btn-sm" title="Registar Licencia" href="{{ route('licencia.create', ['id' => $inspeccion->id]) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-incognito" viewBox="0 0 16 16" style="color: #ffff">
