                                    ...
                                    @endif
                                        ...
                                        <td> 
                                            ...
                                            <div style="display: flex; justify-content: center;">
                                                <a class="btn btn-warning btn-sm" style="margin: 0 3px;" title="Desea Editar el pago de la regalia" href="{{ route('pago_regalia.edit', $pago_regalia->id) }}"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
