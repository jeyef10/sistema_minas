...
class LicenciaController extends Controller
{
    ...
    public function getComprobanteDetalles($id)
    {
        ...
        return response()->json([
            ...
            'forma_pago' =>$comprobante_pago->tipo_pago->forma_pago,
            'codigo_banco' => $comprobante_pago->banco->codigo_banco ?? 'N/A', 
            'nombre_banco' => $comprobante_pago->banco->nombre_banco ?? 'N/A', 
            'n_referencia' => $comprobante_pago->n_referencia ?? 'N/A',
